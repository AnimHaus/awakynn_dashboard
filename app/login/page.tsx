            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full rounded-xl border border-[#E4EBFE] bg-white px-4 py-3 pr-11 text-sm text-gray-900 placeholder:text-gray-300 outline-none focus:border-[#2A61F9] focus:ring-2 focus:ring-[#2A61F9]/10 transition-all"
                />
                <button
                  type="button"
